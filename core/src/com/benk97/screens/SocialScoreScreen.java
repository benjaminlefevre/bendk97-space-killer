...
public class SocialScoreScreen extends ScreenAdapter {
    ...
    public SocialScoreScreen(Assets assets, SpaceKillerGame game, int score) {
        ...
        iconGame = new Sprite(assets.get(ICON_GAME));
        google = new Sprite(assets.get(ICON_GOOGLE));
        fontSmall = assets.get(FONT_SPACE_KILLER_SMALL);
        fontSmall.setColor(Color.BLACK);
        font = assets.get(FONT_SPACE_KILLER_MEDIUM);
