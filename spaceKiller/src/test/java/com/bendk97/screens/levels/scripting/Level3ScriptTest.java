...
public class Level3ScriptTest extends LevelScriptTest {
    ...
    public void initLevelScript() {
        this.scripting = new Level3Script(screen, assets, entityFactory, tweenManager, player, scriptItemExecutor, engine);
    }
    ...
    public void mists_are_created_every_12_seconds() {
        ...
        verify(stageSetEntityFactory, times(21)).createForeground(any(Texture.class), anyFloat());
    }
    ...
    public void boss_happens_end_of_level() {
        ...
        verify(scriptItemExecutor).execute(argThat(script -> script.typeShip == BOSS_LEVEL_3));
    }
    ...
    public void boss_never_happens_when_game_over() {
        ...
        verify(scriptItemExecutor, never()).execute(argThat(script -> script.typeShip == BOSS_LEVEL_3));
    }
